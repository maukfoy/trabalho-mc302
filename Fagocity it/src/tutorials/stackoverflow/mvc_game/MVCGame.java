package tutorials.stackoverflow.mvc_game;
...
public class MVCGame implements Runnable {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new MVCGame());
    }
...
class MainPanel extends JFrame {
    ...
    public MainPanel() {
    	...
    	add(screen);
        label = new JLabel("Guess what color!", JLabel.CENTER);
        screen.add(label, BorderLayout.NORTH);
        screen.add(view, BorderLayout.CENTER);
        screen.add(control, BorderLayout.SOUTH);
