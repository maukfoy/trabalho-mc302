...
public class EndController {
	...
	public EndController (GameController controller, HUDController hud, MouseController mouse)
	{
	...
	{	
		...
		/*Botão Play*/
		if (mouseOver (mx, my, 82, 270, 190, 65 ))
		{	
		...
		/*Botão Quit*/
		if (mouseOver (mx, my, 82, 702, 190, 65 ))
		{
			System.exit(1);
		}
		
		/*Botão Help*/
		if (mouseOver (mx, my, 82, 489 , 190, 65 ))
		{
			GameStatus.status = STATUS.Help;
		}
		
		/*Botão Back da tela Help*/
		if (mouseOver (mx, my, 864, 900, 190, 65 ) )
		{
